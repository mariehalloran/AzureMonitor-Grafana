...
export function getMissingDatasourceScene(missingDs: string, reporter: string, pluginReporter: Reporter, requiredDatasources = "Azure Monitor and Prometheus datasources") {
